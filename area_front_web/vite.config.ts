...
export default defineConfig(({ mode }) => {
  ...
  return {
    define: {
      ...
      'process.env.DEEZER_CLIENT_ID': JSON.stringify(env.DEEZER_CLIENT_ID),
      'process.env.DEEZER_CLIENT_SECRET': JSON.stringify(env.DEEZER_CLIENT_SECRET),
      'process.env.DEEZER_CLIENT_SCOPE': JSON.stringify(env.DEEZER_CLIENT_SCOPE),
